...
class ShelvesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shelf" do
    assert_difference("Shelf.count") do
      post shelves_url, params: { shelf: { cover: @shelf.cover, description: @shelf.description, title: @shelf.title, user_id: @shelf.user_id } }
    end
  ...
  test "should update shelf" do
    patch shelf_url(@shelf), params: { shelf: { cover: @shelf.cover, description: @shelf.description, title: @shelf.title, user_id: @shelf.user_id } }
